...
import com.service.entidades.Carro;
import com.service.servicio.CarroService;
...
public class CarroControler {
	...
	public ResponseEntity <List<Carro>> listarCarrosPorUsuarioId(@PathVariable("id") int id){
